...
class GaussianRBFNetworkMC(nn.Module):
    def __init__(self, gaussian_regularizer, centers_regularizer, weights_regularizer, 
                 task_type, centers, n_features, n_outputs, n_centers=None):
        super(GaussianRBFNetwork, self).__init__()
        ...
        self.weights = nn.Parameter(torch.randn(self.n_centers, self.n_outputs))
